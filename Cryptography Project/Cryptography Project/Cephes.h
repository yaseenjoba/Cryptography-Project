...
public:
	...
	static long double cephes_igamc(long double a, long double x);
	static long double cephes_igam(long double a, long double x);
	static long double cephes_lgam(long double x);
