...
long double Cephes::cephes_igamc(long double a, long double x)
{
...
long double Cephes::cephes_igam(long double a, long double x)
{
...
long double Cephes::cephes_lgam(long double x)
{
...
double Cephes::cephes_erf(double x)
{
	...
	if (fabs(x) > 2.2)
		return 1.0 - Cephes::cephes_erfc(x);
...
double Cephes::cephes_erfc(double x)
{
	...
	if (fabs(x) < 2.2)
		return 1.0 - Cephes::cephes_erf(x);
	if (x < 0)
		return 2.0 - Cephes::cephes_erfc(-x);
